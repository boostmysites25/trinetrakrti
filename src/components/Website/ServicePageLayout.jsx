          ...
          <div className="w-full hidden md:flex flex-col gap-10">
                ...
                {services.map((item, index) => (
                  <Link
                    ...
                    style={{ 
                      ...
                      transform: `translateX(${item.link === pathname ? '5px' : '0px'})` 
                    }}
                  >
                    <div className="flex items-center gap-2">
                      <div className="relative">
                        <img loading="lazy" src={item.icon} alt={item.title} className="min-w-5 w-5 h-5 object-contain relative z-10" />
                        {item.link === pathname && (
                    ...
                    <PiCaretDoubleRightBold className={`text-md ${item.link === pathname ? 'text-white' : 'text-[#C7AC5F] group-hover:translate-x-1'} transition-all duration-300`} />
                  </Link>
                ))}
              </div>
            </div>
            ...
            >
              ...
              <div className="w-[3.5rem] h-[3.5rem] bg-[#C7AC5F] text-white rounded-full p-3 flex justify-center items-center shadow-lg relative">
                ...
                <div className="absolute inset-0 rounded-full bg-[#C7AC5F50] ai-pulse" style={{ animationDelay: '0.5s' }}></div>
              </div>
