    ...
    >
      ...
      <div className="wrapper w-full pt-[10rem] pb-[5rem] flex flex-col-reverse lg:grid grid-cols-[60%_40%] items-center gap-5 relative z-10">
        <div className="flex flex-col gap-6 items-start justify-center">
          ...
          >
            At TrinetraKrti, we specialize in delivering cutting-edge AI
            technology solutions that empower businesses to thrive in the
            digital age. Our expertise spans across various domains, ensuring
            that your organization stays ahead of the curve with intelligent
