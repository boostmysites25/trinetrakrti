  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <Link
          to={item.link}
          className="text-primary group-hover:text-white transition-all duration-300 text-md flex gap-2 items-center"
        >
      ...
      <div className="absolute top-3 right-3 w-6 h-6 rounded-full bg-[#C7AC5F10] border border-[#C7AC5F30] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <svg
          className="w-3 h-3 text-[#C7AC5F] group-hover:text-white transition-colors duration-300"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
