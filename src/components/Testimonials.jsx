  ...
  return (
    ...
    >
      <div className="wrapper grid lg:grid-cols-2 gap-10 w-full">
        ...
        >
          <div className="ai-decorative-line mb-5">
          ...
          <p className="text-gray-600 text-sm mb-5 max-w-[30rem] text-center lg:text-start">
            We are proud to have served thousands of clients worldwide and we
            continue to do so with the same level of excellence that has made us
            one of the leading brands in our industry.
          </p>
          <img
            width="150"
            height="50"
