...
const internshipListings = [
  {
    ...
    stipend: "Competitive",
    description:
      "Join our AI research team to work on cutting-edge projects in machine learning and natural language processing.",
    requirements: [
  ...
  },
  {
    ...
    stipend: "Competitive",
    description:
      "Gain hands-on experience in web development using modern frameworks and technologies.",
    requirements: [
  ...
  },
  {
    ...
    stipend: "Competitive",
    description:
      "Learn and apply UI/UX design principles to create intuitive and engaging user experiences.",
    requirements: [
      "Basic knowledge of design tools like Figma or Adobe XD",
      "Understanding of UI/UX principles",
      "Creative mindset and attention to detail",
      "Ability to receive and implement feedback",
      "Portfolio showcasing design projects (even academic ones)",
    ],
  ...
  },
  {
    ...
    stipend: "Competitive",
    description:
      "Work with our data science team to analyze data, build models, and extract meaningful insights.",
    requirements: [
      ...
      "Eagerness to learn and apply data science techniques",
